...
public class EdgeFields {
    ...
    public static final Field<String> NAME = new Field<>(fields, initializers, Field.Namespace.NULL, CyNetwork.NAME, null, String.class);
    public static final CVField TYPE = new CVField(fields, initializers, Field.Namespace.NULL, CyEdge.INTERACTION, "interaction_type");
