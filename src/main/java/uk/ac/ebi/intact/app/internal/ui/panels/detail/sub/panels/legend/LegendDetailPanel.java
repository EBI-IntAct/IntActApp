package uk.ac.ebi.intact.app.internal.ui.panels.detail.sub.panels.legend;
...
import uk.ac.ebi.intact.app.internal.ui.panels.detail.sub.panels.legend.panels.edge.EdgeLegendPanel;
import uk.ac.ebi.intact.app.internal.ui.panels.detail.sub.panels.legend.panels.node.NodeLegendPanel;
...
public class LegendDetailPanel extends AbstractDetailPanel implements StyleUpdatedListener {
    ...
    private JButton createResetStyleButton() {
        ...
        resetStylesButton.addActionListener(e -> new Thread(() -> {
            ...
            manager.style.resetStyles(true, false);
