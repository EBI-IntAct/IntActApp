...
public class NodeFields {
    ...
    public static final Field<String> AC = new Field<>(fields, initializers, Field.Namespace.INTACT, "AC", "id", String.class, true);
    public static final Field<String> NAME = new Field<>(fields, initializers, Field.Namespace.NULL, CyNetwork.NAME, "interactor_name", String.class, true);
    public static final Field<String> PREFERRED_ID = new Field<>(fields, initializers, Field.Namespace.INTACT, "Preferred Id", "preferred_id", String.class, true);
    public static final CVField PREFERRED_ID_DB = new CVField(fields, initializers, Field.Namespace.INTACT, "Preferred Id Database", "preferred_id_database_name", "preferred_id_database_mi_identifier", SourceOntology.MI, true);
    public static final CVField TYPE = new CVField(fields, initializers, Field.Namespace.INTACT, "Type", "type", true);
    ...
    public static final ListField<String> ORTHOLOG_GROUP_ID = new ListField<>(fields, initializers, Field.Namespace.ORTHOLOGY, "Ortholog group ids", String.class, "ortholog_group", true);
    public static final ListField<String> GROUP_PARTICIPANTS = new ListField<>(fields, initializers, Field.Namespace.ORTHOLOGY, "Group participants", String.class, true);
    ...
    public static final Field<String> ELABEL_STYLE = new Field<>(fields, initializers, Field.Namespace.NULL, "enhancedLabel Passthrough", null, String.class, false,
            "label: attribute=\"name\" labelsize=12 labelAlignment=center outline=true outlineColor=black outlineTransparency=130 outlineWidth=5 background=false color=white dropShadow=false");
