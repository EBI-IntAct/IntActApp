...
import uk.ac.ebi.intact.app.internal.tasks.group.ShowGroupPanelTask;

import java.util.Properties;

import static org.cytoscape.work.ServiceProperties.*;

public class ShowGroupPanelTaskFactory extends AbstractTaskFactory {
    final Manager manager;
    boolean show = false;

    public ShowGroupPanelTaskFactory(final Manager manager) {
        this.manager = manager;
    }

    public TaskIterator createTaskIterator() {
        return new TaskIterator(new ShowGroupPanelTask(manager, this, show));
    }
