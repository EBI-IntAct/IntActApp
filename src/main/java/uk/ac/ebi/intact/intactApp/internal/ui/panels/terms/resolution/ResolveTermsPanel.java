...
import static uk.ac.ebi.intact.intactApp.internal.ui.utils.ComponentUtils.SizeType;
import static uk.ac.ebi.intact.intactApp.internal.ui.utils.ComponentUtils.resizeHeight;
    ...
    private void createControlButtons() {
        ...
        importButton.addActionListener(e -> {
            ...
            if (interactorsToQuery.isEmpty()) {
                ...
                TaskFactory factory = new ImportNetworkTaskFactory(iNetwork, interactorsToQuery.stream().map(interactor -> interactor.ac).collect(toList()), null, null);
