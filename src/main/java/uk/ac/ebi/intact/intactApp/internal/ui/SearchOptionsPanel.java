...
public class SearchOptionsPanel extends JPanel {
    ...
    public SearchOptionsPanel(final IntactManager manager, final boolean isPubMed,
    ...
    public SearchOptionsPanel(final IntactManager manager, final boolean isPubMed, final boolean isDisease) {
        this(manager, isPubMed, isDisease, true);
    }

    // Special constructor used for new NetworkSearchTaskFactory options.
    public SearchOptionsPanel(final IntactManager manager) {
    ...
    private void addNodesFieldValueChanged() {
        ...
        if (n == null) {
            try {
                val = Integer.parseInt(additionalNodesValue.getText());
    ...
    private void textFieldValueChanged() {
        ...
        if (n == null) {
            try {
                val = Double.parseDouble(confidenceValue.getText());
            } catch (NumberFormatException nfe) {
                val = inputError();
            }
