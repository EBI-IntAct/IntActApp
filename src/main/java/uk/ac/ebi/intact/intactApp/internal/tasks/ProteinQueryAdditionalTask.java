...
public class ProteinQueryAdditionalTask extends AbstractTask implements ObservableTask {
    ...
    public ProteinQueryAdditionalTask(final IntactManager manager) {
    ...
    public void run(TaskMonitor monitor) {
        ...
        manager.execute(new TaskIterator(new LoadTermsTask(intactNetwork, sp.toString(), sp.getTaxId(), confidence,
