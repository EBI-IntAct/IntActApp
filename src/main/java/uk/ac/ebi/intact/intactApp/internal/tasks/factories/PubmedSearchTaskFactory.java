...
import uk.ac.ebi.intact.intactApp.internal.ui.PubMedQueryPanel;
...
public class PubmedSearchTaskFactory extends AbstractNetworkSearchTaskFactory {
    ...
    public PubmedSearchTaskFactory(IntactManager manager) {
    ...
    public boolean isReady() {
        return manager.haveURIs() && queryComponent.getText() != null && queryComponent.getText().length() > 0;
    }
            ...
            public void run(TaskMonitor m) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PubMedQueryPanel panel = new PubMedQueryPanel(manager, intactNetwork, terms,
                                optionsPanel);
    ...
    private static class MySearchComponent extends JTextField {
